...
/**
 * An activity representing a single MainActivity detail screen. This
 * activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link MainActivityListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link MainActivityDetailFragment}.
 */
public class MainActivityDetailActivity extends FragmentActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                //
                NavUtils.navigateUpTo(this, new Intent(this, MainActivityListActivity.class));
                return true;
        }
